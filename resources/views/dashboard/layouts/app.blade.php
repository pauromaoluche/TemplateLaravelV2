        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <div id="breadcrumb" class="shadow-lg mb-3 bg-body-tertiary rounded border-left-primary"
                        style="background-color: white">
                        <div class="breadcrumb mb-0 d-flex justify-content-between align-items-center"
                            style="background-color: white">
